...
import 'package:fooddelivery_backend/base/no_data_page.dart';
import 'package:fooddelivery_backend/controller/cart_controller.dart';
import 'package:fooddelivery_backend/models/cart_model.dart';
...
class CartHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<int> itemsPerOrder = cartItemsPerOrderToList(); // 3,2,3 stores the number of item in each order
    var listCounter =0;
